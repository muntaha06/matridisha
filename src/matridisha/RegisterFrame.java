...
public class RegisterFrame extends JFrame {
    ...
    public RegisterFrame() {
        ...
        regBtn.setBackground(darkPink); regBtn.setForeground(Color.WHITE);
        ...
        main.add(Box.createRigidArea(new Dimension(0, 20))); main.add(regBtn);
    ...
    private JTextField createF(String t) {
        JTextField f = new JTextField(); setupField(f, t); return f;
    }
    ...
    private void registerUser() {
        try (Connection conn = DBConnection.getConnection()) {
            ...
            dispose();
        } catch (Exception ex) { showCustomMsg("Error: Fill all info correctly!"); }
    }

    private void showCustomMsg(String m) {
        UIManager.put("OptionPane.background", Color.WHITE);
        UIManager.put("Panel.background", Color.WHITE);
        JOptionPane.showMessageDialog(this, "<html><font color='#C71585'><b>" + m + "</b></font></html>", "Matridisha", JOptionPane.INFORMATION_MESSAGE);
    }
}